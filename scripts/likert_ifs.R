...
path_rds <- 'dados_processados/dados_categoricos_if.rds'
dados_categoricos_if <- read_rds(path_rds)
...
dados_grupo3_likert <- dados_categoricos_if %>% select(q3_7, q3_8)  
glimpse(dados_grupo3_likert)

## selecionando as questoes com respostas categoricas binarias
dados_grupo3_binarias <- dados_categoricos_if %>%
